...
variable "sql_secondary_location" {
  description = "Región del servidor SQL secundario del Auto-Failover Group (ADR-06 U4) — distinta de var.location. Ver envs/prod/variables.tf para el detalle real de regiones probadas."
  type        = string
}
