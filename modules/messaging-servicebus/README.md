...
- `environment`, `location`, `resource_group_name`, `max_delivery_count` (default 5), `tags`.
...
No depende de ningún otro módulo (capa 2: plataforma de ejecución — mismo nivel que `compute-appservice` y `compute-serverless`).
